...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: 981px; width: 1015px">
        <asp:Login id="controlLog" runat="server" displayrememberme="False"
	        ...
	        onauthenticate="Login_Authenticate" borderpadding="10" font-bold="True" font-size="Small" forecolor="#003399" instructiontext="Si ya posee un usuario puede loguearse en el sistema con sus datos, sino puede realizar el registro rapidamente.">
        </asp:Login>
